...
export let PageDeclarations = {
  ...
  menu: {
    ...
    path: 'menu',
    asTab: false,
    tabIcon: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAABmJLR0QA/wD/AP+gvaeTAAAAVElEQVQ4jWNgGHGAMXH6WR92VqYQahj28/e/NSzsrEwhLSFK8dQwsGbNPQYmahiEDFh+/v63pmbNPaoY9vP3vzVUMQgZjEYKZWA0UqgDBn+kDH4AAOjuOV5mdqZsAAAAAElFTkSuQmCC",
    fullPath: "/tabs/menu",
  },
  wrongEnumEntry: {
    order: 8,
