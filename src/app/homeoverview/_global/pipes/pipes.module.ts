...
@NgModule({
    ...
    declarations: [GetNamePipe, MS2Time, Color2VarColor, MS2LocalString, RoundTo2DecString, RoundTo1DecString ],
    exports: [ GetNamePipe, MS2Time, Color2VarColor, MS2LocalString, RoundTo2DecString, RoundTo1DecString ]
  })
